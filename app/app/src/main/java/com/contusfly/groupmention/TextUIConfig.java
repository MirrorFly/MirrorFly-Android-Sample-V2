...
public class TextUIConfig implements Parcelable {
    ...
    /**
     * Returns a value of {@link Typeface}.
    ...
    public Typeface generateTypeface() {
        String familyName1 = this.familyName != null ? this.familyName : "";
        Typeface typeface = Typeface.create(familyName1, Typeface.NORMAL);
        if (this.textStyle >= 0) {
            switch (this.textStyle) {
                case Typeface.NORMAL:
                    typeface = Typeface.create(familyName1, Typeface.NORMAL);
                    break;
                case Typeface.BOLD:
                    typeface = Typeface.create(familyName1, Typeface.BOLD);
                    break;
                case Typeface.ITALIC:
                    typeface = Typeface.create(familyName1, Typeface.ITALIC);
                    break;
                case Typeface.BOLD_ITALIC:
                    typeface = Typeface.create(familyName1, Typeface.BOLD_ITALIC);
                    break;

                default:
                    throw new IllegalStateException("Unexpected value: " + this.textStyle);
            }
        }
        return typeface;
    }
    ...
    public static class Builders {
         ...
         * @since 3.1.1
         */
        public Builders(@NonNull Context context, @StyleRes int textAppearanceRes) {
         ...
         */
        @NonNull
        public Builders setTextBackgroundColor(@ColorInt int textBackgroundColor) {
            this.textBackgroundColor = textBackgroundColor;
            return this;
        }
         ...
         */
        @NonNull
        public Builders setTextColor(@ColorInt int textColor) {
            this.textColor = textColor;
            return this;
        }

        /**
         * Sets a value of {@link Typeface}.
         * <li>Typeface.NORMAL</li>
         * <li>Typeface.BOLD</li>
         * <li>Typeface.ITALIC</li>
         * <li>Typeface.BOLD_ITALIC</li>
         ...
         */
        @NonNull
        public Builders setTextStyle(int textStyle) {
            this.textStyle = textStyle;
            return this;
        }
         ...
         */
        @NonNull
        public Builders setTextSize(int textSize) {
            this.textSize = textSize;
            return this;
        }

...
public final class ActivityGroupInfoBinding implements ViewBinding {
  ...
  private ActivityGroupInfoBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull PrivateChatToggleLayoutBinding privateChatView,
      @NonNull AppCompatImageView profileImage, @NonNull ProgressBar progressSpinner,
      @NonNull EmojiAppCompatTextView reportGroup, @NonNull View statusDivider,
      @NonNull EmojiAppCompatTextView subTitle, @NonNull EmojiAppCompatTextView textMedia,
      @NonNull Toolbar toolbar, @NonNull View viewAllMediaDivider) {
  ...
  public static ActivityGroupInfoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGroupInfoBinding((CoordinatorLayout) rootView, addParticipant,
          ...
          muteTitle, nestedScrollView, binding_privateChatView, profileImage, progressSpinner,
          reportGroup, statusDivider, subTitle, textMedia, toolbar, viewAllMediaDivider);
    }

...
public final class LayoutCallOptionsBinding implements ViewBinding {
  ...
  @NonNull
  public final PoorInternetConnectionBinding layoutSlowNetwork;
  ...
  private LayoutCallOptionsBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull PoorInternetConnectionBinding layoutSlowNetwork) {
    ...
    this.layoutSlowNetwork = layoutSlowNetwork;
  }
  ...
  public static LayoutCallOptionsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.layout_slow_network;
      View layoutSlowNetwork = ViewBindings.findChildViewById(rootView, id);
      if (layoutSlowNetwork == null) {
        break missingId;
      }
      PoorInternetConnectionBinding binding_layoutSlowNetwork = PoorInternetConnectionBinding.bind(layoutSlowNetwork);

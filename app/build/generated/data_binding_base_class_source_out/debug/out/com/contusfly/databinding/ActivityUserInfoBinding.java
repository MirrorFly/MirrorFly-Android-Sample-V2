...
public final class ActivityUserInfoBinding implements ViewBinding {
  ...
  private ActivityUserInfoBinding(@NonNull CoordinatorLayout rootView,
      ...
      @NonNull ImageView profileImage, @NonNull CustomTextView reportUser,
      @NonNull View statusDivider, @NonNull CustomTextView statusText,
      @NonNull CustomTextView statusTitle, @NonNull CustomTextView subTitle,
      @NonNull CustomTextView textMedia, @NonNull Toolbar toolbar,
  ...
  public static ActivityUserInfoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityUserInfoBinding((CoordinatorLayout) rootView, appBarLayout,
          ...
          muteTitle, nestedScrollView, profileImage, reportUser, statusDivider, statusText,
          statusTitle, subTitle, textMedia, toolbar, viewAllMediaDivider);
    }

...
public final class RowMediaLinksItemBinding implements ViewBinding {
  ...
  private RowMediaLinksItemBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ConstraintLayout layoutLink, @NonNull ConstraintLayout layoutLinkContent,
      @NonNull ConstraintLayout layoutLinkNavigation, @NonNull View linksSeparator,
      @NonNull ConstraintLayout mediaViewItem, @NonNull AppCompatTextView textLinkContent,
      @NonNull AppCompatTextView textLinkDescription, @NonNull AppCompatTextView textLinkHost,
      @NonNull AppCompatTextView textLinkTitle) {
  ...
  public static RowMediaLinksItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RowMediaLinksItemBinding((ConstraintLayout) rootView, imageLinkNavigation,
          imageLinkPreview, layoutLink, layoutLinkContent, layoutLinkNavigation, linksSeparator,
          mediaViewItem, textLinkContent, textLinkDescription, textLinkHost, textLinkTitle);
    }

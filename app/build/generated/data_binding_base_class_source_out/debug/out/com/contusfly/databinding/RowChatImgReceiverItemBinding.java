...
public final class RowChatImgReceiverItemBinding implements ViewBinding {
  @NonNull
  ...
  private RowChatImgReceiverItemBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull RoundRectCornerImageView imageReceiveItem, @NonNull ImageView imgDownloadCancel,
      ...
      @NonNull AppCompatTextView textReceiverRetry, @NonNull LinearLayout viewChatRevImg,
  ...
  @NonNull
  public static RowChatImgReceiverItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static RowChatImgReceiverItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.row_chat_img_receiver_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static RowChatImgReceiverItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new RowChatImgReceiverItemBinding((LinearLayout) rootView, downloadProgressBuffer,
          binding_headerStarredMessageSender, icBalloon, icStarRv, imageReceiveItem,
          imgDownloadCancel, progressImageReceive, receivedImgForward, rlHeaderReceiver,
          rowChatImage, textChatDate, textReceiveTime, textReceiverRetry, viewChatRevImg,
          viewDivider, viewMessageDate, viewReceiveDownload, viewReceiveDownloadProgress,
          viewReceiveImage, binding_viewRevImageCaption, viewSenderName);
    }

...
public final class ViewChatFooterBinding implements ViewBinding {
  ...
  private ViewChatFooterBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull RelativeLayout layoutViewAudio, @NonNull ImageView replyClose,
      @NonNull LinearLayout suggestionLayout, @NonNull RecyclerView suggestionRecycler,
      @NonNull TextView textAudioRecordCancel, @NonNull TextView textAudioRecordTimer,
      @NonNull TextView textAudioSlideToCancel, @NonNull CustomTextView textNoMsg,
      @NonNull View viewAudioRecordSpace, @NonNull LinearLayout viewChat,
      @NonNull LinearLayout viewChildFooter, @NonNull LinearLayout viewFooter,
      @NonNull ReplyViewBinding viewTextReplyLayout) {
  ...
  public static ViewChatFooterBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ViewChatFooterBinding((ConstraintLayout) rootView, actionAttachment,
          ...
          imageChatSend, imageChatSmiley, imageViewAudio, layoutViewAudio, replyClose,
          suggestionLayout, suggestionRecycler, textAudioRecordCancel, textAudioRecordTimer,
          textAudioSlideToCancel, textNoMsg, viewAudioRecordSpace, viewChat, viewChildFooter,
          viewFooter, binding_viewTextReplyLayout);
    }

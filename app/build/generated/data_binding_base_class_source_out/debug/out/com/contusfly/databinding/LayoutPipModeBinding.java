...
public final class LayoutPipModeBinding implements ViewBinding {
  ...
  private LayoutPipModeBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull TextView userProfileName, @NonNull TextView userProfileName1,
      @NonNull ImageView userProfilePic, @NonNull ImageView userProfilePic1,
      @NonNull TextureViewRenderer userVideoSurface, @NonNull TextureViewRenderer userVideoSurface1,
  ...
  public static LayoutPipModeBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutPipModeBinding((LinearLayout) rootView, callerStatusLayout,
          ...
          participantsCount, userProfileName, userProfileName1, userProfilePic, userProfilePic1,
          userVideoSurface, userVideoSurface1, viewSpeakingIndicator, viewSpeakingIndicator1);
    }

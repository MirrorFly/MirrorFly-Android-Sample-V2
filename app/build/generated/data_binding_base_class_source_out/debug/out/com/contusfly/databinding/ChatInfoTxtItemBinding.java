...
public final class ChatInfoTxtItemBinding implements ViewBinding {
  ...
  private ChatInfoTxtItemBinding(@NonNull LinearLayout rootView, @NonNull CustomTextView editTxtId,
      @NonNull ImageView icStar, @NonNull ImageView imageSentRecall,
      @NonNull ImageView imgTxtStatus, @NonNull MessageTextView txtSendChat,
  ...
  public static ChatInfoTxtItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ChatInfoTxtItemBinding((LinearLayout) rootView, editTxtId, icStar, imageSentRecall,

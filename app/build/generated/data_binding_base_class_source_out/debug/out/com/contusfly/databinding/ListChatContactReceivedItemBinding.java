...
public final class ListChatContactReceivedItemBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public final LinearLayout viewContactReceivedHolder;
  ...
  private ListChatContactReceivedItemBinding(@NonNull LinearLayout rootView,
      ...
      @NonNull RelativeLayout rowChatContact, @NonNull ImageView sendImgForward,
      ...
      @NonNull LinearLayout viewContactReceivedHolder, @NonNull View viewContactSeparator,
    ...
    this.viewContactReceivedHolder = viewContactReceivedHolder;
  ...
  @NonNull
  public static ListChatContactReceivedItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ListChatContactReceivedItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.list_chat_contact_received_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ListChatContactReceivedItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.view_contact_received_holder;
      LinearLayout viewContactReceivedHolder = ViewBindings.findChildViewById(rootView, id);
      if (viewContactReceivedHolder == null) {
        break missingId;
      }
      ...
      return new ListChatContactReceivedItemBinding((LinearLayout) rootView,
          binding_headerStarredMessageSender, imageAudioFavorite, imageContactPicture,
          imageRightArrow, rlHeaderReceiver, rowChatContact, sendImgForward, textAudioTime,
          textChatDate, textContactAction, textContactName, viewContactReceivedHolder,
          viewContactSeparator, viewDivider, viewMessageDate, viewSenderName,

...
private  var OVERSCROLL_TRANSLATION_MAGNITUDE = 0.0f

/** The magnitude of translation distance when the list reaches the edge on fling. */
private var FLING_TRANSLATION_MAGNITUDE = 0.0f
...
class BounceEdgeEffectFactory : RecyclerView.EdgeEffectFactory() {
    ...
    private var privateChatListener : PrivateChatReleaseListener?=null
    ...
    override fun createEdgeEffect(recyclerView: RecyclerView, direction: Int): EdgeEffect {
        ...
        return object : EdgeEffect(recyclerView.context) {
            ...
            override fun onRelease() {
                ...
                if(privateChatListener!=null && recyclerView.translationY > 140){
                    privateChatListener!!.privateChatReleased()
                }
            }
    ...
    fun setTranslationValue(overscrollmagnitude:Float,flingmagnitude:Float){
        OVERSCROLL_TRANSLATION_MAGNITUDE=overscrollmagnitude
        FLING_TRANSLATION_MAGNITUDE=flingmagnitude
    }

    fun setListener(listener:PrivateChatReleaseListener){
        privateChatListener=listener
    }

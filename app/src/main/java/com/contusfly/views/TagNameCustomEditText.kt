 ...
 * @version 1.0
 */
class TagNameCustomEditText : AppCompatEditText {
    ...
    override fun onDraw(canvas: Canvas) {
        super.onDraw(canvas)
        if (text!!.isNotEmpty() && hint != null) {
            val hintX = width - compoundPaddingRight - paint.measureText(hint.toString()) - 16
            canvas.drawText(hint.toString(), hintX, baseline.toFloat(), paint)
        }
    }

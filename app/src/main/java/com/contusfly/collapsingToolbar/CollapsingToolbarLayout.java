...
package com.contusfly.collapsingToolbar;
...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,
                ...
                com.contusfly.R.style.Widget_Design_MultilineCollapsingToolbar);
        // END MODIFICATION
        ...
        mCollapsingTextHelper.setCollapsedTextAppearance(
                com.contusfly.R.style.ActionBar_Title);
        // END MODIFICATION
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, com.contusfly.R.styleable.CollapsingToolbarLayoutExtension, defStyleAttr, 0);
        mCollapsingTextHelper.setMaxLines(typedArray.getInteger(com.contusfly.R.styleable.CollapsingToolbarLayoutExtension_maxLines, 3));
        mCollapsingTextHelper.setLineSpacingExtra(typedArray.getFloat(com.contusfly.R.styleable.CollapsingToolbarLayoutExtension_lineSpacingExtra, 0));
        mCollapsingTextHelper.setLineSpacingMultiplier(typedArray.getFloat(com.contusfly.R.styleable.CollapsingToolbarLayoutExtension_lineSpacingMultiplier, 1));
        typedArray.recycle();
        // END MODIFICATION
    }
